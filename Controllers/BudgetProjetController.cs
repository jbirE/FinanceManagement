...
//        public async Task<ActionResult<BudgetProjetDto>> CreateBudgetProjet(BudgetProjet budgetProjet)
//        {
//            try
//            {
//                var createdBudget = await _budgetService.CreateBudgetProjetAsync(budgetProjet);
...
//        public async Task<IActionResult> UpdateBudgetProjet(int id, BudgetProjet budgetProjet)
//        {
//            if (id != budgetProjet.IdBudgetProjet)
//                return BadRequest("ID mismatch");

//            try
//            {
//                await _budgetService.UpdateBudgetProjetAsync(budgetProjet);
//                return NoContent();
//            }
//            catch (ArgumentException ex)
//            {
